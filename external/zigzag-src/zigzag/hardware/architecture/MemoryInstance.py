...
class MemoryInstance:
    ...
    def __init__(
        ...
        @param compression (dict | None): Per-operand compression config, e.g. {"I2": {"ratio": 2.0, "decompression_latency": 0}}.
        """
        ...
        self.compression = compression if compression is not None else {}
